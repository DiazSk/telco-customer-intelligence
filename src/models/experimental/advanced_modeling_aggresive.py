...
class ChurnModelingPipeline:
    ...
    def prepare_features(self, df: pd.DataFrame) -> tuple:
        ...
        if 'TotalCharges' in X.columns and 'MonthlyCharges' in X.columns:
            ...
            X['spending_acceleration'] = X['MonthlyCharges'] / (X['TotalCharges'] / (X['tenure'] + 1) + 0.01)
    ...
    def calculate_business_metrics(self, y_true, y_pred_proba, X_test, df_test):
        ...
        for threshold in thresholds:
            ...
            base_tp_value = customer_values[tp_high_value].sum() * self.business_params['intervention_success_rate']
            ...
            intervention_cost = high_value_interventions.sum() * self.business_params['retention_campaign_cost']
