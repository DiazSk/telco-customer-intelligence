    ...
    queries = {
        ...
        "10. Business Metrics Summary": """
            SELECT 
                ...
                (SELECT ROUND(SUM(MonthlyCharges), 2) FROM telco_customers WHERE Churn = 'Yes') as monthly_revenue_at_risk,
...
def generate_insights(results):
    ...
    if revenue_df is not None:
        churned_revenue = revenue_df[revenue_df['Churn'] == 'Yes']['total_monthly_revenue'].values[0]
